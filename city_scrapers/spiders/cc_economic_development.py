...
class CcEconomicDevelopmentSpider(CityScrapersSpider):
    name = "cc_economic_development"
    agency = "Creve Coeur Economic Development Committee"
