...
class StlDevelopmentSpider(CityScrapersSpider):
    name = "stl_development"
    agency = "St. Louis Local Development Company"
    ...
    def start_requests(self):
        url = (
            ...
            "documents/local-development-company-documents.cfm"
        )
        ...
        calendar_urls = [
            (
                ...
                "past-meetings.cfm?span=-30&department=336"
            ),
    ...
    def _get_event_urls(self, response):
        ...
        for url, sponsor in zip(event_urls, event_sponsors):
            if "local development" in sponsor.lower():
    ...
    def _parse_title(self, response):
        ...
        if "special" in header.lower():
            title = "St. Louis Local Development Company Special Board Meeting"
        else:
            title = "St. Louis Local Development Company Board"

        if "canceled" in header.lower() or "cancelled" in header.lower():
            title += " cancelled"
