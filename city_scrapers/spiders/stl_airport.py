...
class StlAirportSpider(CityScrapersSpider):
    name = "stl_airport"
    agency = "St. Louis Airport Commission"
    timezone = "America/Chicago"
    custom_settings = {"ROBOTSTXT_OBEY": False}
    start_urls = [
        (
            "https://www.stlouis-mo.gov/events/"
            "past-meetings.cfm?span=-30&department=311"
        ),
    ...
    def _parse_title(self, response):
        ...
        if "commission" in title:
            result = "Airport Commission"
        else:
            result = "Program Review Committee"
