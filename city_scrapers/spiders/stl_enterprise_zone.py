...
class StlEnterpriseZoneSpider(CityScrapersSpider):
    name = "stl_enterprise_zone"
    agency = "St. Louis Enhanced Enterprise Zone Board"
    ...
    def start_requests(self):
        url = (
            ...
            "documents/enhanced-enterprise-zone-commission-documents.cfm"
        )
        ...
        calendar_urls = [
            (
                ...
                "past-meetings.cfm?span=-30&department=452"
            ),
    ...
    def _get_event_urls(self, response):
        ...
        for url, sponsor in zip(event_urls, event_sponsors):
            if "enterprise" in sponsor.lower():
    ...
    def _parse_title(self, response):
        ...
        title = title.replace("CANCELED", "CANCELLED").strip()
        return title
    ...
    def _parse_location(self, response):
        ...
        description = response.css("div#EventDisplayBlock h3::text").get()
