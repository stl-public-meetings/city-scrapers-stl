...
class CcHorticultureSpider(CityScrapersSpider):
    name = "cc_horticulture"
    agency = "Creve Coeur Horticulture, Ecology and Beautification Committee"
    ...
    def _get_event_urls(self, response):
        ...
        for link, detail in zip(links, details):
            if "horticulture" in detail.lower():
