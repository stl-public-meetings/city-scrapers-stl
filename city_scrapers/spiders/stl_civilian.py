...
class StlCivilianSpider(CityScrapersSpider):
    name = "stl_civilian"
    agency = "St. Louis Civilian Oversight Board"
    ...
    def start_requests(self):
        url = (
            ...
            "civilian-oversight-board/documents/civilian-oversight-board-meetings.cfm"
        )
        ...
        calendar_urls = [
            (
                ...
                "past-meetings.cfm?span=-30&department=456"
            ),
    ...
    def _get_event_urls(self, response):
        ...
        for url, sponsor in zip(event_urls, event_sponsors):
            if "civilian oversight" in sponsor.lower():
    ...
    def _parse_title(self, response):
        ...
        title = "Civilian Oversight Board"
    ...
    def _parse_location(self, response):
        ...
        if "zoom" in description:
            name = "Zoom"
            address = ""
        elif "teleconference" in description:
            name = "Teleconference"
            address = ""
        elif "virtual" in description:
            name = "Virtual"
            address = ""
