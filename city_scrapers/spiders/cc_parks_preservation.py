...
class CcParksPreservationSpider(CityScrapersSpider):
    name = "cc_parks_preservation"
    agency = "Creve Coeur Parks and Historic Preservation Committee"
