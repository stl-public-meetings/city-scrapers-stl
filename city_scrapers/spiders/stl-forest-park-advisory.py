...
class StlForestParkAdvisorySpider(CityScrapersSpider):
    ...
    def _parse_location(self, response):
        ...
        if 'zoom' in title.lower() or 'zoom' in meeting_type.lower():
            ...
            infos = response.xpath('//*/strong[text()="Location:"]/parent::p/text()').getall()
    ...
    def _get_agenda_urls(self, response):
        links = response.xpath('//*/a[contains(@href, "FPAB") and contains(@href, "Agenda")]/@href').getall()
        titles = response.xpath('//*/span[@class="td-value" and contains(text(), "FPAB Agenda")]/text()').getall()
    ...
    def _get_minute_urls(self, response):
        links = response.xpath('//*/a[contains(@href, "FPAB") and contains(@href, "Minutes")]/@href').getall()
        titles = response.xpath('//*/span[@class="td-value" and contains(text(), "FPAB Minutes")]/text()').getall()
