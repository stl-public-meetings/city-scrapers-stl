...
class StlRedevelopmentSpider(CityScrapersSpider):
    name = "stl_redevelopment"
    agency = "St. Louis Land Clearance for Redevelopment Authority"
    ...
    def start_requests(self):
        url = (
            ...
            "documents/land-clearance-for-redevelopment-authority-documents.cfm"
        )
        ...
        calendar_urls = [
            (
                ...
                "past-meetings.cfm?department=239&span=-30"
            ),
    ...
    def _get_event_urls(self, response):
        ...
        for url, sponsor in zip(event_urls, event_sponsors):
            if "redevelopment" in sponsor.lower():
