...
class StlTaxFinancingSpider(CityScrapersSpider):
    name = "stl_tax_financing"
    agency = "St. Louis Tax Increment Financing Commission"
    ...
    def start_requests(self):
        url = (
            ...
            "documents/tax-increment-financing-commission.cfm"
        )
    ...
    def _parse_title(self, response):
        ...
        if "canceled" in title.lower() or "cancelled" in title.lower():
            title = "Cancelled Tax Increment Financing Commission"
        elif "tax increment financing" in title.lower():
            title = "Tax Increment Financing Commission"
